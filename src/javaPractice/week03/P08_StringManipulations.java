...
public class P08_StringManipulations {
    public static void main(String[] args) {
        ...
        System.out.println(str1);//emre can
        ...
        // lenght methodu
        System.out.println(str1.length()); // 8 //length 1'den başlar boşluk dahil sayar
        System.out.println(str1.length() - 1); //7

        //substring methodu
        System.out.println(str2.substring(1, 6)); //mre C
        System.out.println(str2.substring(4)); // Can
        System.out.println(str2.substring(8)); // "" hiclik
        //concat methodu
        //int sayi=01;
        System.out.println(str2.concat("_wise"));//Emre Can_wise
        //System.out.println(str2.substring(9)); // StringIndexOutOfBoundsException
        String name3 = "ÇekoslavakyalılaştıramadıklarımızdanMısınız";
        System.out.println(name3.length()); //43
        System.out.println(name3.substring(42)); //z
        System.out.println(name3.substring(43)); // "" hiclik

        // contains methodu
        String login = "Üye Girişi";
        System.out.println(login.contains("Üye")); //true

        //startsWith endsWith methodu
        System.out.println(login.startsWith("Ü")); //true ( ü olsa false verir )
        System.out.println(login.endsWith("i")); //true

        // indexof methodu
        System.out.println(login.indexOf("ş")); //8
        System.out.println(login.lastIndexOf('i')); //9
        System.out.println(login.lastIndexOf('p')); //"" hiclik
        ...
        \\s+ :yanyana olan birden fazla space i tek space yapiyor?
        \\d : digit
        \\D : digit olmayan her şey
        \\w : harf veya rakam ve _
        \\W : harf veya rakam ve _ olmayan herşey
         */
        String marka = "Wise3@*9 Quarter";
        marka = marka.replaceAll("\\d", ""); // Wise@* Quarter
        System.out.println(marka);
        marka = marka.replaceAll("\\W", " "); //Wise   Quarter
        System.out.println(marka);
