...
public class P01_printFonksiyonu {
    ...
    */
    String ac= "**********  WISE BANK   **********";
    String hsg="WISE ATM’YE HOŞGELDİNİZ";
    String a = "1 – Bakiye Sorgulama";
    String b="2 – Para Yatırma";
    String c="3 – Para Çekme";
    String d="4 – Bilgi Güncelleme";
    String e="5 – Kart İade";
    String ka="**********  WISE BANK   **********";
