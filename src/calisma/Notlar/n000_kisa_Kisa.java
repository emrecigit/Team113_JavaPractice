...
public class n000_kisa_Kisa {
        ...
        *objelerin davranışlarını tanımlamak için methodaları kullanır Class uyesidir.
        ...
        /* int sayi1=scan.next() den sonra int sayi2 = scan.nextLine() kullanilirsa  atlama sorunu ve çözümü
         scanner adı ne tanımlandıysa ona göre örnegin scan.nextLine(); next() den bir alt satira yazilir.*/
         //                                                 Data Casting
